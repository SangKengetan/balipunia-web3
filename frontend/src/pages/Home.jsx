          ...
          <div className="flex flex-col lg:flex-row gap-10 mb-20 items-start">
            ...
            <div className="w-full lg:w-7/12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm hover:border-yellow-400 hover:shadow-md transition-all">
                  <div className="w-10 h-10 bg-yellow-100 text-yellow-600 rounded-xl flex items-center justify-center mb-3">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                  </div>
                  <h4 className="font-bold text-base mb-2">Apa itu Kripto?</h4>
                  <p className="text-xs text-slate-600 leading-relaxed">Mata uang digital yang aman dan dapat digunakan untuk bertransaksi secara online di seluruh dunia tanpa bank perantara.</p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm hover:border-yellow-400 hover:shadow-md transition-all">
                  ...
                  <h4 className="font-bold text-base mb-2">Apa itu Blockchain?</h4>
                  <p className="text-xs text-slate-600 leading-relaxed">Buku kas digital publik tempat semua transaksi dicatat permanen, transparan, dan tidak bisa dipalsukan.</p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm hover:border-yellow-400 hover:shadow-md transition-all">
                  ...
                  <h4 className="font-bold text-base mb-2">Dompet Kripto?</h4>
                  <p className="text-xs text-slate-600 leading-relaxed">Identitas digital Anda (seperti MetaMask) yang digunakan untuk menyimpan aset kripto dengan aman.</p>
                </div>

                <div className="bg-yellow-50 p-5 rounded-2xl border border-yellow-200 shadow-sm hover:shadow-md transition-all">
                  <div className="w-10 h-10 bg-yellow-400 text-slate-900 rounded-xl flex items-center justify-center mb-3">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                  </div>
                  <h4 className="font-bold text-base mb-2 text-slate-800">Wajib Punya Kripto?</h4>
                  <p className="text-xs text-slate-700 leading-relaxed"><strong>TIDAK.</strong> Anda tetap bisa mepunia menggunakan Rupiah (Bank/E-Wallet). Kripto hanyalah opsi tambahan.</p>
                </div>
              </div>
